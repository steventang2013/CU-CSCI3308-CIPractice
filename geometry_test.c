...
START_TEST(test_coord_2d_area_triangle)
{
    ...
    c.x = 50;
    c.y = 20;
    ck_assert(coord_2d_area_triangle(&a, &b, &c) == 272);
    ...
    c.x = 15;
    c.y = 5;
    ck_assert(coord_2d_area_triangle(&a, &b, &c) == 60);
    ...
    c.x = 15;
    c.y = 5;
    ck_assert(coord_2d_area_triangle(&a, &b, &c) == 228);
...
Suite* coord_2d_suite(void)
{
    ...
    TCase* tc_coord_2d_area_triangle = tcase_create("test_coord_2d_area_triangle");
